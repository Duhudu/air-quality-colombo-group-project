...
namespace GroupProject
{
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        private AirQualityData GenerateAirQualityData(int sensorId)
        {
            ...
            {
                SensorId = sensorId,
                PM2_5 = new Random().Next(0, 100),
                PM10 = new Random().Next(0, 100),
                Pm1 = new Random().Next(0, 100),
                RH = new Random().Next(0, 100),
                Temp = new Random().Next(-10, 50),
                Wind = new Random().Next(0, 100),
                Aqi = new Random().Next(0, 100)
            };
